        ...
        <div className="mb-8 flex items-center justify-between">
          <div>
            ...
            <p className="text-gray-600 mt-2">
              Create and manage shortcut-based message templates for faster
              responses
            </p>
          </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2">
            <Card>
              <CardHeader>
                <CardTitle>
                  Your Quick Replies ({quickReplies.length})
                </CardTitle>
              </CardHeader>
              <CardContent>
                {quickReplies.length === 0 ? (
                  <div className="text-center py-12">
                    ...
                    <p className="text-gray-500 mb-4">
                      Create your first quick reply template to get started
                    </p>
                    <Button onClick={handleCreate}>
                      <Plus className="h-4 w-4 mr-2" />
                      Add Quick Reply
              ...
              <CardContent className="space-y-4">
                <div>
                  ...
                  <p className="text-sm text-gray-600">
                    Shortcuts must start with "/" (e.g., /hello, /thanks). Type
                    the shortcut in chat and press space or enter to expand.
                  </p>
                </div>
                <div>
                  <h4 className="font-medium text-sm mb-2">
              ...
              <CardContent className="space-y-3">
                <div className="text-sm">
                  ...
                  <p className="text-gray-600">
                    Hi #FIRST_NAME, welcome to #PAGE_NAME!
                  </p>
                </div>
                <div className="text-sm">
                  <Badge variant="secondary" className="font-mono mb-1">
                ...
                <div className="text-sm">
                  ...
                  <p className="text-gray-600">
                    Thank you for contacting us, #FIRST_NAME!
                  </p>
                </div>
              </CardContent>
            </Card>
          ...
          <DialogContent className="max-w-2xl">
            ...
            <div className="space-y-6">
              ...
              <div className="space-y-2">
                ...
                />
                <p className="text-xs text-gray-500">
                  Use #FIRST_NAME and #PAGE_NAME for dynamic content
                </p>
              </div>
